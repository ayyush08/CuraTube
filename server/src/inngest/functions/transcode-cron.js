    ...
    export const processUploadedVideo = inngest.createFunction(
        ...
        { event: "video/publish" },
        async ({ event }) => {
            const { videoId, title, now, videoUrl, thumbnailLocalPath,signedVideoPublicId } = event.data;
            ...
            try {
                ...
                await transcodeToHLS(videoUrl, hlsOutputDir);
                ...
                await deleteFileFromCloudinary(signedVideoPublicId, "video");
            } catch (error) {
